  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-2xl font-semibold tracking-tight text-zinc-900 dark:text-zinc-50">{t("Organizations.title")}</h1>
          <p className="text-sm text-zinc-500 mt-1">{t("Organizations.subtitle")}</p>
        </div>
