...
export function AskNatalieHeader() {
    ...
    return (
        <Card className={cn(
            "shadow-none border-none transition-all duration-700 ease-in-out",
            isFocused 
                ? "bg-linear-to-r from-indigo-500/20 via-purple-500/20 to-pink-500/20 dark:from-indigo-500/40 dark:via-purple-500/40 dark:to-pink-500/40 scale-[1.01]" 
                : "bg-linear-to-r from-indigo-500/10 via-purple-500/10 to-pink-500/10 dark:from-indigo-500/25 dark:via-purple-500/25 dark:to-pink-500/25"
        )}>
            <div className="p-8 flex flex-col md:flex-row items-center justify-between gap-6">
                <div className="flex flex-row justify-center items-center space-x-5">
                    ...
                    <div className="transition-all duration-500">
                        <h2 className={cn(
                            ...
                            isFocused ? "text-primary font-medium" : ""
                        )}>
                            Search with Natalie
                        </h2>
                ...
                <div className={cn(
                    "w-full md:w-auto md:min-w-[400px] flex gap-2 relative transition-all duration-500 ease-out",
                    isFocused ? "md:min-w-[500px]" : ""
                )}>
                    <div className={cn(
