...
import { Plus, Trash2, GripVertical, FileText, CheckSquare, Calendar as CalendarIcon, Type, PenTool } from 'lucide-react';
                  ...
                  <div className="flex gap-2 items-center">
                    ...
                    >
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value="date"><div className="flex items-center gap-2"><CalendarIcon className="w-3 h-3"/> {t("fieldTypes.date")}</div></SelectItem>
