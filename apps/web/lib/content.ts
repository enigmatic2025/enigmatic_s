...
export const techStack: { key: string; icon: SimpleIcon; name: string }[] = [
  ...
  { key: "typescript", icon: siTypescript, name: "TypeScript" },
  { key: "supabase", icon: siSupabase, name: "Supabase" },
  { key: "postgres", icon: siPostgresql, name: "PostgreSQL" },
  { key: "python", icon: siPython, name: "Python" },
  { key: "langchain", icon: siLangchain, name: "LangChain" },
