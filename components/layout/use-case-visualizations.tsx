    ...
    <div className="relative flex flex-col items-center justify-center h-full w-full p-4 md:p-8">
      <div className="w-full max-w-5xl h-[600px] bg-background border border-border rounded-xl shadow-sm overflow-hidden flex">
        ...
        <div className="flex-1 flex flex-col bg-background relative">
          ...
          <div className="h-14 border-b border-border flex items-center justify-between px-6 md:hidden">
          ...
          <div className="flex-1 overflow-y-auto p-6 space-y-8">
            ...
            <div className="flex gap-4 max-w-3xl mx-auto">
              ...
              <div className="flex-1 space-y-2">
                ...
                {/* Attachment Card */}
                <div className="flex items-center gap-3 p-3 border border-border rounded-xl bg-muted/20 w-fit mt-2">
                  <div className="h-10 w-10 rounded-lg bg-red-100 dark:bg-red-900/20 flex items-center justify-center text-red-600">
                    <FileText className="h-5 w-5" />
                  </div>
                  <div>
                    <p className="text-sm font-medium">Signed_POD.pdf</p>
